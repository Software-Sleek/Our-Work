        ...
        1239: function (e, t, n) {
            ...
            var s = (function (e) {
                function t(e) {
                    ...
                    return (
                        (n.state = { isOpen: !1, modalVideoWidth: n.getWidthFulfillAspectRatio(n.props.ratio, window.innerHeight, window.innerWidth) }),
                    ...
                    o(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    document.addEventListener("keydown", this.keydownHandler.bind(this)), window.addEventListener("resize", this.resizeModalVideoWhenHeightGreaterThanWindowHeight.bind(this));
                                },
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    clearTimeout(this.timeout),
                                        (this.timeout = setTimeout(function () {
                                            ...
                                            e.state.modalVideoWidth != t && e.setState({ modalVideoWidth: t });
                                        }, 10));
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return a.default.createElement(i.default, { classNames: this.props.classNames.modalVideoEffect, timeout: this.props.animationSpeed }, function () {
                                        return e.state.isOpen
                                            ? a.default.createElement(
                                                ...
                                                a.default.createElement(
                                                    ...
                                                    a.default.createElement(
                                                        "div",
                                                        { className: e.props.classNames.modalVideoInner, style: t },
                                                        a.default.createElement(
                                                            "div",
                                                            { className: e.props.classNames.modalVideoIframeWrap, style: n },
            ...
            (t.Z = s),
                (s.defaultProps = {
                    ...
                    aria: { openMessage: "You just opened the modal video", dismissBtnMessage: "Close the modal by clicking here" },
                });
        },
        129: function (e, t, n) {
            "use strict";
                ...
                c = (function (e) {
                        ...
                        return (
                            ...
                            (t.getClassNames = function (e) {
                                var n = t.props.classNames,
                                    o = "string" === typeof n,
                                    a = o ? (o && n ? n + "-" : "") + e : n[e];
                                return { className: a, activeClassName: o ? a + "-active" : n[e + "Active"], doneClassName: o ? a + "-done" : n[e + "Done"] };
                            }),
                            t
                        );
                    }
                    ...
                    return (
                        ...
                        (a.render = function () {
                            ...
                            return (
                                delete e.classNames,
                                i.default.createElement(r.default, l({}, e, { onEnter: this.onEnter, onEntered: this.onEntered, onEntering: this.onEntering, onExit: this.onExit, onExiting: this.onExiting, onExited: this.onExited }))
                            );
                        }),
                        o
                    );
        ...
        644: function (e, t, n) {
            ...
            var f = (function (e) {
                ...
                function o(t, n) {
                    ...
                    return (o.appearStatus = null), t.in ? (r ? ((a = u), (o.appearStatus = p)) : (a = c)) : (a = t.unmountOnExit || t.mountOnEnter ? l : u), (o.state = { status: a }), (o.nextCallback = null), o;
                }
                (n = e), ((t = o).prototype = Object.create(n.prototype)), (t.prototype.constructor = t), (t.__proto__ = n);
                var r = o.prototype;
                return (
                    ...
                    (r.getTimeouts = function () {
                        ...
                        return (e = t = n = o), null != o && "number" !== typeof o && ((e = o.exit), (t = o.enter), (n = void 0 !== o.appear ? o.appear : t)), { exit: e, enter: t, appear: n };
                    }),
            ...
            (f.contextTypes = { transitionGroup: o.object }),
                ...
                (f.propTypes = {}),
                (f.defaultProps = { in: !1, mountOnEnter: !1, unmountOnExit: !1, appear: !1, enter: !0, exit: !0, onEnter: m, onEntering: m, onEntered: m, onExit: m, onExiting: m, onExited: m }),
                (f.UNMOUNTED = 0),
                (f.EXITED = 1),
                (f.ENTERING = 2),
                (f.ENTERED = 3),
